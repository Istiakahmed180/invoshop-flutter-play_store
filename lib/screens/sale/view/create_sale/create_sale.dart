...
import 'package:invoshop/screens/sale/view/create_sale/sub_sections/sales_bill.dart';
...
class _CreateSaleState extends State<CreateSale> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const CustomAppBar(appBarName: "New Sales"),
        body: Obx(() {
