...
import 'package:invoshop/screens/sale/controller/return_sale_bills_controller.dart';

class ReturnSalesBill extends StatefulWidget {
  const ReturnSalesBill({super.key});

  @override
  State<ReturnSalesBill> createState() => _ReturnSalesBill();
}

class _ReturnSalesBill extends State<ReturnSalesBill> {
  final ReturnSaleBillsController returnSaleBillsController =
      Get.put(ReturnSaleBillsController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(appBarName: "Return Sales Bill"),
      body: Obx(() => returnSaleBillsController.isLoading.value
          ? const CustomLoading(
              withOpacity: 0.0,
            )
          : Padding(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  CustomDatePicker(
                                    ...
                                    initialDate: returnSaleBillsController
                                        .selectedDate.value,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  CustomDropdownField(
                                      ...
                                      dropdownItems: returnSaleBillsController
                                          ...
                                          : returnSaleBillsController
                                              ...
                                              .toList(),
                                      onChanged: (value) {
                                        returnSaleBillsController.warehouseId
                                            .value = returnSaleBillsController
                                                .warehouseList
                                                .firstWhere((item) =>
                                                    item.name == value)
                                                .id ??
                                ...
                                children: [
                                  ...
                                  CustomDropdownField(
                                    ...
                                    dropdownItems: returnSaleBillsController
                                        ...
                                        ? ["Not Found"]
                                        : returnSaleBillsController.customerList
                                            .map((item) => [
                                                  item.firstName ?? "",
                                                  item.lastName ?? ""
                                                ].join(" ").trim())
                                    ...
                                    onChanged: (value) {
                                      ...
                                      returnSaleBillsController.customerId
                                ...
                                children: [
                                  ...
                                  CustomDropdownField(
                                      ...
                                      dropdownItems: returnSaleBillsController
                                              .billerList.isEmpty
                                          ? ["Not Found"]
                                          : returnSaleBillsController.billerList
                                              .map((item) =>
                                                  item.billerCode as String)
                                              .toList(),
                                      onChanged: (value) {
                                        returnSaleBillsController.billerId
                                            .value = returnSaleBillsController
                                                .billerList
                                                .firstWhere((item) =>
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    maxLines: 3,
                                    controller: returnSaleBillsController
                                        ...
                                        cells: [
                                          ...
                                          DataCell(Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                "${returnSaleBillsController.quantities[index]}",
                                              ),
                                              const SizedBox(
                                                width: 10,
                                              ),
                                              GestureDetector(
                                                onTap: () {
                                                  returnSaleBillsController.updateQuantity(
                                                      index,
                                                      returnSaleBillsController
                                                                  .quantities[
                                                              index] +
                                          ...
                                          DataCell(Center(
                                            child: Text(
                                              "${currencyController.currencySymbol}${returnSaleBillsController.subtotals[index].toStringAsFixed(2)}",
                                            ),
                                          )),
                                          DataCell(
                                            GestureDetector(
                      ...
                      children: [
                        CustomElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            returnSaleBillsController.calculateSubtotals(
                                product: posController.selectedItems);
                          },
                        ),
                        CustomElevatedButton(
                          buttonName: "Create Return Sale",
                          buttonColor: AppColors.groceryPrimary,
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              returnSaleBillsController.postReturnSaleCreate(
                                  product: posController.selectedItems);
                            }
                          },
                        ),
      ...
      children: [
            ...
            child: DataTable(
              ...
              rows: [
                DataRow(cells: [
                  ...
                  DataCell(Center(
                    child: Text(
                      "${currencyController.currencySymbol}${returnSaleBillsController.totalTax.toStringAsFixed(2)}",
                    ),
                  )),
                  DataCell(Center(
                    child: Text(
                      "${currencyController.currencySymbol}${returnSaleBillsController.totalDiscount.toStringAsFixed(2)}",
                    ),
                  )),
                  DataCell(Center(
                    child: Text(
                      "${currencyController.currencySymbol}${returnSaleBillsController.totalSubtotals.toStringAsFixed(2)}",
                    ),
                  )),
                ])
              ],
        ...
        Column(
          ...
          children: [
            ...
            TextField(
              controller: returnSaleBillsController.shippingAmount,
  ...
  Widget buildGrandTotalSection() {
    return Container(
      ...
      child: Text(
        "Grand Total : ${currencyController.currencySymbol}${returnSaleBillsController.totalSubtotals.toStringAsFixed(2)}",
