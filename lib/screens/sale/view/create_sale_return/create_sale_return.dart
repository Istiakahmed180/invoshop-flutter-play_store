...
import 'package:invoshop/screens/sale/view/create_sale_return/sub_sections/return_sales_bills.dart';

class CreateSaleReturn extends StatefulWidget {
  const CreateSaleReturn({super.key});
...
class _CreateSaleReturnState extends State<CreateSaleReturn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const CustomAppBar(appBarName: "Create Sale Return"),
        body: Obx(() {
  ...
  Widget _buildBody() {
    return Column(
      children: [
        ...
        _buildButtonRow(),
        SizedBox(height: 10.h),
        _buildSectionTitle("Select Sale Items"),
        SizedBox(height: 10.h),
        _buildProductGrid(),
        SizedBox(height: 12.h),
      ],
