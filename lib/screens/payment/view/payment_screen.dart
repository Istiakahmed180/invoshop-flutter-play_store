...
import 'package:ai_store/screens/payment/controller/payment_controller.dart';
import 'package:ai_store/screens/payment/model/bank_account_model.dart';
import 'package:ai_store/screens/payment/view/bank_account/edit_bank_account_screen.dart';
...
class PaymentScreen extends StatelessWidget {
      ...
      body: Obx(
        () => paymentController.isLoading.value
            ...
            : RefreshIndicator(
                ...
                onRefresh: () async {
                  await paymentController.getBankAccounts();
                },
                child: Column(
                  children: [
                    _buildHeaderSection(),
                    Expanded(
                      child: paymentController.bankAccountList.isNotEmpty
                          ? _buildAccountList(paymentController)
                          : Center(
                              child: Text(
  ...
  Widget _buildAccountList(PaymentController paymentController) {
