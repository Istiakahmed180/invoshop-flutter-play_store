...
import 'package:invoshop/screens/purchase/view/purchase_bills/purchase_bills.dart';

class CreatePurchase extends StatefulWidget {
  const CreatePurchase({super.key});

  @override
  State<CreatePurchase> createState() => _CreatePurchase();
}

class _CreatePurchase extends State<CreatePurchase> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const CustomAppBar(appBarName: "New Purchase"),
        body: Obx(() {
