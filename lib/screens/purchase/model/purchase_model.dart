class PurchaseModel {
  ...
  PurchaseModel({this.success, this.data});
...
class PurchaseData {
  ...
  int? warehouseId;
  int? supplierId;
  String? purchaseDateAt;
  String? purchaseTimeAt;
  String? amount;
  String? taxAmount;
  ...
  PurchaseData.fromJson(Map<String, dynamic> json) {
    ...
    purchaseDateAt = json['purchase_date_at'];
    purchaseTimeAt = json['purchase_time_at'];
    amount = json['amount'];
    ...
    warehouse = json['warehouse'] != null
        ...
        : null;
    if (json['purchase_products'] != null) {
      purchaseProducts = <PurchaseProducts>[];
      json['purchase_products'].forEach((v) {
        purchaseProducts!.add(PurchaseProducts.fromJson(v));
      });
    }
  }
}
...
class PurchaseProducts {
  ...
  PurchaseProducts.fromJson(Map<String, dynamic> json) {
    id = json['id'];
